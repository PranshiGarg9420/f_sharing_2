...
def handleShowList(client):
    ...
    for c in clients:
        ...
        connected_with_= clients[c]['connected_with']
        message=''
        if connected_with_:
            message= f"{counter},{c},{client_addr}, connected with , tiul {connected_with_}"
        else:
            message= f"{counter},{c},{client_addr}, available , tiul"
